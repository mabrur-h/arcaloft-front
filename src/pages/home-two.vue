...
@Component({
    ...
    async asyncData (context: Context) {
        ...
        const featuredProducts = runOnlyOnServer(() => context.$shopApi.getFeaturedProducts({ limit: 12 }), null)
...
export default class Page extends Vue {
    ...
    featuredProductsSource (tab: {categorySlug: string}): Promise<IProduct[]> {
        return this.$shopApi.getFeaturedProducts({ limit: 12, category: tab.categorySlug })
    }
